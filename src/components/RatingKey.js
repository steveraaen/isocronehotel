...
export default class RatingKey extends Component {
	...
	render() {
			...
			return(
			<div style={{marginTop:"1vh", width: "22vw", backgroundColor: "#0D2B9F", textAlign: 'center', fontSize: '20pt', fontWeight: 'bold',color: "yellow", padding: "15px", borderWidth: "5px", borderColor: "white", borderRadius: "8px"}}>
				<Collapsible trigger="Ratings Key" triggerStyle={{width: ".24vw", backgroundColor: "#0D2B9F", textAlign: 'center', fontSize: '20pt', fontWeight: 'bold',color: "yellow", padding: "15px", borderWidth: "5px", borderColor: "white", borderRadius: "8px"}}>				
					<div style={{flex: 1, flexDirection: 'column', backgroundColor: "black"}}>
