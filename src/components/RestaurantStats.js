                ...
                <div className="statBox">
						...
						<div style={{display: 'flex', flexDirection: "row", alignItems: 'flex-start'}}>
								<div style={{width: "14vw", fontSize: 24, fontWeight: 'bold', textAlign: 'left'}}>
									<div style={{display: 'flex', flexDirection: 'row', alignItems: 'center', marginLeft: "1vw"}}>Avg Price<div style={{fontSize: '12px' , marginLeft: "1vw"}}>(1-3)</div></div>
								</div>
						...
						<div style={{display: 'flex', flexDirection: "row"}}>
								<div style={{width: "14vw", fontSize: 24, fontWeight: 'bold', textAlign: 'left'}}>
									<div style={{display: 'flex', flexDirection: 'row', alignItems: 'center', marginLeft: "1vw"}}>Avg Rating<div style={{fontSize: '12px' , marginLeft: "1vw"}}>(1-5)</div></div>
								</div>
