...
export default class DistanceKey extends Component {
	...
	render() {
		...
		if(this.props.showKey) {
			return(
			<div style={{width: "18vw", backgroundColor: "#121B59", textAlign: 'center', fontSize: '1.4vw', fontWeight: 'bold',color: "yellow", paddingTop: "1vw", paddingBottom: "1vw",borderWidth: ".6vw", borderRadius: ".6vw", marginBottom: '2vh'}}>

				<Collapsible trigger="Walking Range" triggerStyle={{width: "18vw", backgroundColor: "#121B59", textAlign: 'center', fontSize: '1.4vw', fontWeight: 'bold',color: "yellow", padding: "1vw", borderWidth: ".1vw", borderColor: "white", borderRadius: "1vw"}}>				
